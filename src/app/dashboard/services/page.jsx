...
export default function ServicesPage() {
  ...
  const services = [
    { id: 1, name: "صيانة - توريد - تنفيذ برك السباحة", desc: "مصممة للعمل في البيئات التشغيلية القاسية", date: "سبتمبر 16, 2035", icon: "🟢" },
    { id: 2, name: "صيانة - توريد - تنفيذ برك السباحة", desc: "مصممة للعمل في البيئات التشغيلية القاسية", date: "سبتمبر 16, 2035", icon: "🔵" },
    { id: 3, name: "صيانة - توريد - تنفيذ برك السباحة", desc: "مصممة للعمل في البيئات التشغيلية القاسية", date: "سبتمبر 16, 2035", icon: "🟢" },
    { id: 4, name: "صيانة - توريد - تنفيذ برك السباحة", desc: "مصممة للعمل في البيئات التشغيلية القاسية", date: "سبتمبر 16, 2035", icon: "🔵" },
    { id: 5, name: "صيانة - توريد - تنفيذ برك السباحة", desc: "مصممة للعمل في البيئات التشغيلية القاسية", date: "سبتمبر 16, 2035", icon: "🟢" },
    { id: 6, name: "صيانة - توريد - تنفيذ برك السباحة", desc: "مصممة للعمل في البيئات التشغيلية القاسية", date: "سبتمبر 16, 2035", icon: "🔵" },
    { id: 7, name: "صيانة - توريد - تنفيذ برك السباحة", desc: "مصممة للعمل في البيئات التشغيلية القاسية", date: "سبتمبر 16, 2035", icon: "🔵" },
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        ...
        <div className="flex flex-col text-right gap-2">
          ...
          <div className="relative">
            <input type="text" placeholder="تاريخ الخدمة" className="w-full h-12 pr-10 pl-4 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-[#EB682C] text-right" />
          ...
          <table className="w-full text-right text-sm">
            <thead className="bg-gray-50/80 text-gray-500 border-b border-gray-100">
              <tr>
                ...
                <th className="py-4 px-6 font-bold">الخدمات</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-100">
              {services.map((service) => (
                <tr key={service.id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="py-4 px-6 text-gray-500">{service.date}</td>
                  <td className="py-4 px-6 text-gray-500">{service.desc}</td>
