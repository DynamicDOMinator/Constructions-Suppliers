...
import { User, Mail, EyeOff, ChevronDown } from 'lucide-react';
      ...
      <form className="flex flex-col gap-5">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex flex-col gap-2 text-right w-full md:w-1/2">
            ...
            <div className="relative">
              ...
              <input type="text" placeholder="الاسم" className="w-full h-14 px-4 pl-12 border border-gray-200 rounded-2xl text-sm focus:outline-none focus:border-[#EB682C]" />
            </div>
          </div>
          <div className="flex flex-col gap-2 text-right w-full md:w-1/2">
            ...
            <div className="relative">
              ...
              <input type="email" placeholder="البريد الالكتروني" className="w-full h-14 px-4 pl-12 border border-gray-200 rounded-2xl text-sm focus:outline-none focus:border-[#EB682C]" />
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2 text-right">
          ...
          <div className="flex flex-row-reverse h-14 border border-gray-200 rounded-2xl relative focus-within:border-[#EB682C] bg-white">
            <input type="tel" className="flex-1 h-full px-4 text-sm focus:outline-none text-left bg-transparent" dir="ltr" />
        ...
        <div className="flex flex-col gap-2 text-right">
          ...
          <div className="relative">
            ...
            <input type="password" placeholder="••••••••••••" className="w-full h-14 px-4 pl-12 border border-gray-200 rounded-2xl text-sm focus:outline-none focus:border-[#EB682C] text-left tracking-widest" dir="ltr" />
          </div>
        </div>
