        ...
        <section className="py-20 px-6 md:px-12 bg-white" data-aos="fade-up">
          <div className="text-center mb-16">
            <h2 className="text-2xl md:text-3xl font-bold text-[#EB682C]">
              الموردون <span className="text-black">المعتمدون</span>
            </h2>
          </div>
              ...
              <div key={item} className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-lg transition-shadow p-6 flex flex-col">
                <div className="flex justify-between items-start mb-6 border-b border-gray-100 pb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-800 text-lg">شركة الجبيل للصناعة</h3>
                     <div>
                      <p className="text-sm">
                        تصنيع قطع غيار كهربائية
                      </p>
                     </div>
                    </div>
                  </div>
                  <span className="bg-[#08A02A] text-white text-xs px-3 py-1 rounded-full font-bold">معتمد</span>
                </div>
                
                <p className="text-sm text-gray-600 mb-6 flex-grow leading-relaxed">
                  شركة رائدة في مجال صناعة وتوريد مواد البناء والتشييد، نقدم أفضل المنتجات بأعلى معايير الجودة العالمية لضمان استدامة مشاريعكم.
                </p>
                ...
                <div className="flex justify-between items-center text-xs text-gray-500 mb-6 bg-gray-50 p-3 rounded-lg">
                  <div className="flex flex-col gap-1">
                     ...
                     <span className="font-bold text-gray-400">مقاول من الباطن</span>
                  </div>
                  <div className="flex flex-col gap-1">
                     <span className="text-black">الرياض</span>
